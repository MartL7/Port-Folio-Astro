...
export const projects: Project[] = [
...

  {
    ...
    description: 'Aplicación web para control de Créditos de Clientes de la empresa LOG-IN, con la finalidad de llevar un control de los créditos otorgados a los clientes, así como de los pagos realizados por los mismos.',
  ...
  {
    name: 'Forever 6M',
    description: 'Anuario de compañeros del Grupo M del CBTis 86, con la funcionalidad de iniciar sesión con Google, reaccionar y comentar a cada perfil. Inspirado en el diseño de La Velada IV.',
...

  {
    ...
    description: 'Bot de WhatsApp para la empresa LOGIN Mayorista integrando la API Oficial de WhatsApp. Creado en NodeJS con JavaScript',
